...
// shiftForcePositions: { "g-s": { playerName: "G"|"D"|"R"|"O" } }
// Forces specific players to specific positions in a shift.
// A player forced to "G" overrides the scheduled goalie; the original goalie rejoins the field pool.
// goalieMode: "pairs" (default — 2 shifts per goalie, 4 goalies per game)
//           | "halves" (4 shifts per goalie, 2 goalies per game — one owns H1, one owns H2)
export function generateRotation(seed, players, shiftExclusions = {}, gameExclusions = {}, shiftForceIns = {}, lockedShifts = {}, shiftForcePositions = {}, goalieMode = "pairs") {
